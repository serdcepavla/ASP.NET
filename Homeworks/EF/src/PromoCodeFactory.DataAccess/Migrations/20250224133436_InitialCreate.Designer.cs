...
namespace PromoCodeFactory.DataAccess.Migrations
{
    ...
    [Migration("20250224133436_InitialCreate")]
            ...
            modelBuilder.Entity("PromoCodeFactory.Core.Domain.PromoCodeManagement.PromoCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BeginDate = new DateTime(2025, 2, 23, 16, 34, 29, 827, DateTimeKind.Local).AddTicks(5638),
                            Code = "PC-1",
                            CustomerId = new Guid("a6c8c6b1-4349-45b0-ab31-244740aaf0f0"),
                            ...
                            PartnerName = "OZON",
                            PreferenceId = new Guid("ef7f299f-92d7-459f-896e-078ed53ef99c"),
                            ServiceInfo = "Промокод на 46%"
                        },
                        new
                        {
                            Id = new Guid("f3bb4250-b000-4c52-9238-9558d5820eca"),
                            BeginDate = new DateTime(2025, 2, 23, 16, 34, 29, 847, DateTimeKind.Local).AddTicks(854),
                            Code = "PC-2",
                            CustomerId = new Guid("d54f3eff-5b25-42f2-bdea-067ec5130dc5"),
                            EndDate = new DateTime(2025, 3, 6, 0, 0, 0, 0, DateTimeKind.Local),
